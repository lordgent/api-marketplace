...
const {createMerchant,getMerchantInfo,updateMerchantInfo} = require('../controllers/MerchantController')
const {addProduct,getAllProduct} = require('../controllers/ProductController')
const {addToCart,getCarts,totalPrice} = require('../controllers/CartController')
...
router.put('/merchant', auth,AuthMerchant,uploadFile("imageMerchant"), updateMerchantInfo)
